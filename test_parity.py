...
pages = ['/index.html', '/login.html', '/register.html', '/cek-peserta.html', '/guide.html', '/dashboard.html']
for p in pages:
    s, html = req(p)
...
assert s == 200 and len(tree['data']) == 5
...
assert s == 200 and len(cats['data']) >= 5
print('  [PASS] Admin categories retrieved (5 categories verified)')
