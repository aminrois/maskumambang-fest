...
async function main() {
  ...
  // =========================================================================
  // 4. SEED COMPETITION CATEGORIES, LEVELS & BRANCHES (22 BRANCHES)
  // =========================================================================
      ...
      levels: [
        {
          ...
          slug: 'sd-mi',
          branches: [
            { name: 'Matematika', type: ParticipantType.INDIVIDUAL, fee: 150000, minM: null, maxM: null },
            { name: 'PAI', type: ParticipantType.INDIVIDUAL, fee: 150000, minM: null, maxM: null },
            { name: 'Sains', type: ParticipantType.INDIVIDUAL, fee: 150000, minM: null, maxM: null },
            { name: 'Bahasa Inggris', type: ParticipantType.INDIVIDUAL, fee: 150000, minM: null, maxM: null },
            { name: 'Bahasa Arab', type: ParticipantType.INDIVIDUAL, fee: 150000, minM: null, maxM: null },
          ],
        },
        {
          name: 'SMP/MTs',
          ...
          branches: [
            ...
            { name: 'PAI', type: ParticipantType.INDIVIDUAL, fee: 150000, minM: null, maxM: null },
            { name: 'Sains', type: ParticipantType.INDIVIDUAL, fee: 150000, minM: null, maxM: null },
            { name: 'IPS', type: ParticipantType.INDIVIDUAL, fee: 150000, minM: null, maxM: null },
            { name: 'Bahasa Inggris', type: ParticipantType.INDIVIDUAL, fee: 150000, minM: null, maxM: null },
            { name: 'Bahasa Arab', type: ParticipantType.INDIVIDUAL, fee: 150000, minM: null, maxM: null },
          ],
        },
      ...
      levels: [
        {
          ...
          slug: 'tk-ra-ab',
          branches: [
            { name: 'Mewarnai', type: ParticipantType.INDIVIDUAL, fee: 150000, minM: null, maxM: null },
            { name: 'Kolase', type: ParticipantType.INDIVIDUAL, fee: 150000, minM: null, maxM: null },
            { name: 'Kids Warrior', type: ParticipantType.INDIVIDUAL, fee: 150000, minM: null, maxM: null },
          ],
        },
      ],
    },
      ...
      levels: [
        {
          ...
          slug: 'sd-mi',
          branches: [
            { name: 'Futsal', type: ParticipantType.TEAM, fee: 150000, minM: 5, maxM: 10 },
          ],
        },
        {
          name: 'SMP/MTs',
          ...
          branches: [
            { name: 'Futsal', type: ParticipantType.TEAM, fee: 150000, minM: 5, maxM: 10 },
            { name: 'Bola Voli', type: ParticipantType.TEAM, fee: 150000, minM: 6, maxM: 12 },
          ],
        },
      ],
    },
      ...
      levels: [
        {
          ...
          slug: 'sd-mi',
          branches: [
            { name: 'Master Chef', type: ParticipantType.TEAM, fee: 150000, minM: 2, maxM: 3 },
          ],
        },
        {
          name: 'SMP/MTs',
      ...
      levels: [
        {
          ...
          slug: 'sd-mi',
          branches: [
            { name: 'Grasshopper', type: ParticipantType.TEAM, fee: 150000, minM: 2, maxM: 4 },
          ],
        },
        {
          name: 'SD/SMP/SMA',
          slug: 'sd-smp-sma',
          branches: [
            { name: 'Soccer', type: ParticipantType.TEAM, fee: 150000, minM: 2, maxM: 4 },
            { name: 'Creative', type: ParticipantType.TEAM, fee: 150000, minM: 2, maxM: 4 },
          ],
        },
      ],
    },
  ...
  // =========================================================================
  // 5. SEED PHASE C TEST DATASET (12+ Users, 15+ Registrations, Payments, Check-Ins)
  // =========================================================================
  ...
  for (let i = 0; i < testUsersData.length; i++) {
    ...
    const regNum = `REG-${branch.participantType === ParticipantType.INDIVIDUAL ? 'IND' : 'TIM'}-2026-TEST${String(i + 1).padStart(2, '0')}`;
    const qrToken = `QR-${regNum}-${tu.phone}`;
    
    // Status rotation: 0=APPROVED+CHECKEDIN, 1=APPROVED, 2=WAITING_VERIFICATION, 3=PAYMENT_REJECTED
    ...
    if (branch.participantType === ParticipantType.INDIVIDUAL) {
      ...
      await prisma.teamMember.createMany({
        data: [
          { teamId: team.id, memberName: `Anggota 1 (${tu.name})`, gender: Gender.L, gradeClass: 'Kelas 8' },
          { teamId: team.id, memberName: `Anggota 2 (${tu.name})`, gender: Gender.P, gradeClass: 'Kelas 8' },
        ],
      });
    }
      ...
      if (!existingPay) {
        const p = await prisma.payment.create({
          data: {
            ...
            status: payStatus,
            notes: regStatus === RegistrationStatus.PAYMENT_REJECTED ? 'Nominal kurang Rp 20.000' : 'Testing Payment',
          },
        });
        paymentId = p.id;
      }
      ...
      if (paymentId && bendaharaUser && payStatus !== PaymentStatus.WAITING_VERIFICATION) {
        await prisma.paymentVerificationLog.create({
          data: {
            ...
            rejectionReason: payStatus === PaymentStatus.REJECTED ? 'Nominal transfer tidak sesuai dengan biaya cabang lomba (kurang Rp 20.000).' : undefined,
          },
        });
      }
    }

    // CheckIn record for i % 4 === 0
    if (i % 4 === 0 && bendaharaUser && regStatus === RegistrationStatus.APPROVED) {
